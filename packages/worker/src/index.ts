...
class PostEmail extends OpenAPIRoute {
	...
	async handle(c: AppContext) {
		...
		// The stored row names the first recipient
		...
		// The provider's Message-ID, when known, is what replies to this message will carry.
...
If you didn't request this, you can safely ignore this email.`,
		...
		try {
			await sendOutboundEmail(c.env, recoveryEmail);
		} catch (e) {
